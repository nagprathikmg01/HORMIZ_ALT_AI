        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          ...
          <div className={`lg:col-span-8 rounded-2xl border overflow-hidden shadow-xl ${
            ...
            <div className="relative aspect-video bg-slate-950 flex items-center justify-center overflow-hidden">
              <video
                ref={videoRef}
                src="https://assets.mixkit.co/videos/preview/mixkit-cargo-ship-sailing-in-the-sea-41132-large.mp4"
              ...
              <div className="absolute top-4 left-4 z-10 flex items-center space-x-2">
                <span className="bg-slate-950/90 border border-slate-800 text-blue-400 text-[11px] font-mono px-2.5 py-1 rounded-md flex items-center space-x-1.5">
              ...
              {!isPlaying && (
                <button
                  onClick={togglePlay}
                  className="absolute z-20 h-20 w-20 rounded-full bg-blue-600 text-white flex items-center justify-center pl-1 shadow-2xl hover:scale-110 transition-all"
                >
              ...
              <div className="absolute inset-x-8 top-1/3 bottom-20 pointer-events-none flex flex-col justify-center items-center text-center z-10">
                <div className="bg-slate-950/90 border border-slate-800 p-4 rounded-xl max-w-md">
                  <span className="text-xs font-mono text-blue-400 uppercase tracking-widest block mb-1">SYSTEM ARCHITECTURE PITCH</span>
            ...
            <div className="bg-slate-950 border-t border-slate-800 px-4 py-3 text-xs font-mono">
              ...
              <div className="flex items-center justify-between gap-4">
                <div className="flex items-center space-x-3">
                  <button onClick={togglePlay} className="p-2 rounded-lg bg-slate-900 border border-slate-800 text-blue-400">
                    {isPlaying ? <Pause className="h-4 w-4" /> : <Play className="h-4 w-4 fill-blue-400" />}
                  </button>
                  ...
                  <div className="flex items-center space-x-1 bg-slate-900 p-1 rounded-lg border border-slate-800">
                    {[1.0, 1.25, 1.5, 2.0].map((s) => (
                      <button
                        ...
                        className={`px-2 py-0.5 rounded text-[11px] font-mono ${playbackSpeed === s ? 'bg-blue-950 text-blue-300 border border-blue-800 font-bold' : 'text-slate-400'}`}
                      >
                        {s}x
                      </button>
                    ))}
                  ...
                  return (
                    <div
                      ...
                      className={`p-3 rounded-xl border text-left cursor-pointer transition-all ${
                        isCurrent
                          ? isDark ? 'bg-blue-950/60 border-blue-800 shadow-md' : 'bg-blue-50 border-blue-300 shadow-sm'
                    ...
                    >
                      <div className="flex items-center justify-between">
                        ...
                        {isCurrent && (
                          <span className="bg-blue-950 text-blue-300 text-[10px] font-mono px-2 py-0.5 rounded border border-blue-800 font-bold">
                            CURRENT CHAPTER
                          </span>
                        )}
                      </div>
